...
(function (TSOS) {
    var Kernel = (function () {
        ...
        Kernel.prototype.krnInterruptHandler = function (irq, params) {
            ...
            switch (irq) {
                ...
                case PRINT_INTEGER_IRQ:
                    this.krnTrace("Printing integer " + params[0]);
                    _StdOut.putText(params[0].toString());
                    _CPU.isExecuting = true;
                    break;
                case PRINT_STRING_IRQ:
                    this.krnTrace("Printing string " + params[0]);
        ...
        Kernel.prototype.PrintInteger = function () {
            _KernelInterruptQueue(new TSOS.Interrupt(PRINT_INTEGER_IRQ, _CPU.Yreg));
        };
        ...
        Kernel.prototype.PrintString = function () {
            ...
            try {
                ...
                _KernelInterruptQueue(new TSOS.Interrupt(PRINT_STRING_IRQ, str));
            }
            catch (er) {
