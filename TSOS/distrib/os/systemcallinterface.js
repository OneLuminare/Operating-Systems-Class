...
var TSOS;
(function (TSOS) {
    var SystemCallInterface = (function () {
        function SystemCallInterface() {
        }
        SystemCallInterface.prototype.processSysCall = function (value) {
            // Inits
            var noStart = false;
            var str = "";
            ...
            switch (value) {
                ...
                default:
                    ...
                    _KernelInterruptQueue.enqueue(new TSOS.Interrupt(UNKNOWN_SYSCALL_IRQ, new Array(_CPU.base, _CPU.PC)));
                    // Set noStart to true
                    noStart = true;
                    break;
            }
    ...
    TSOS.SystemCallInterface = SystemCallInterface;
})(TSOS || (TSOS = {}));
