...
(function (TSOS) {
    var MemoryAccessor = (function () {
        function MemoryAccessor(programMemory) {
        ...
        MemoryAccessor.prototype.setAddress = function (address, value) {
        ...
        // Returns: true on set, false on invalid address or number larger than a byte
        MemoryAccessor.prototype.setAddressHexStr = function (address, valueHex) {
        ...
        MemoryAccessor.prototype.getAddress = function (address) {
        ...
        MemoryAccessor.prototype.getAddressHexStr = function (address) {
            // Init return value to fail
            var ret = "";
            // If address in range, set return value to mem value
            if (address >= 0 && address < _MemoryMax)
